...
// theme.config.js
export default {
  projectLink: 'https://github.com/Dax911/ping-t3-docs/tree/main', // GitHub link in the navbar
  docsRepositoryBase: 'https://github.com/Dax911/ping-t3-docs/tree/main', // base URL for the docs repository
  titleSuffix: ' – Nextra',
  nextLinks: true,
  prevLinks: true,
  search: true,
